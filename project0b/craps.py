...
game_timer.start()
dice.standard_rolls_for_debugging(51889428)
for game in irange(1, games_to_play): 
    print('game:', game)
    #Each iteration plays one game
    first_roll = dice.roll().pip_sum() 
          #Roll the dice and record their pip sum
    #print('first_roll:', first_roll)
    #Based on firstRoll, decide how to continue:
    #  immediate win/loss or trying to make point
    if first_roll == 7 or first_roll == 11:
        win_count += 1
        print("game", game, "point", win_count)
        print('first_roll:', first_roll, "win_count:",  win_count, "game", game)                      #Win on the first roll with 7 or 11

    elif first_roll == 2 or first_roll == 3 or first_roll == 12:
        lose_count += 1 
        print('first_roll:', first_roll, "lose_count:",  lose_count, "game", game) 
                             #Lose on the first roll with 2, 3, or 12
        ...
        while(True):                         #Roll until roll point (win) or 7 (lose)
            ...
            if roll == point: 
                ...
                print('roll:', roll, "point", point, "game:", game)               #If made the point first
                win_count += 1 
                #print("game", game, "point", win_count)
                 #...win and this game is over
                break
            elif roll == 7:  
                #print("lose roll:", roll)                #If roll a 7 first
